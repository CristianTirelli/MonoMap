...
@dataclass
class RandomNodeCoolingResetSma(CoolingResetSma):
    STRATEGY_ID: str = field(default=CoolingResetSma.TEMPERATURE_STRATEGY_ID + "RANDOM-NODE", init=False)
...
@dataclass
class RandomNodeMorpherResetSma(MorpherResetSma):
    STRATEGY_ID: str = field(default=MorpherResetSma.TEMPERATURE_STRATEGY_ID + "RANDOM-NODE", init=False)
