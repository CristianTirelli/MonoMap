...
@dataclass
class SimulatedAnnealingSpaceSearchMorpherWarmupSma:
    TEMPERATURE_STRATEGY_ID: str = field(default="MORPHER-SMA-BEST-AND-MAX-CAP_", init=False)
        ...
        while self.sol_cost != 0 and iterations < self.MAX_ITERATIONS:
            ...
            if items >= self.ITEMS_PER_TEMPERATRE - 1:
                ...
                if warming_up:
                    ...
                    # t increase
                    if warming_up_step < 10000:
                        self.temperature += 0.001 / math.log((10000 - warming_up_step) + math.e)
                    else:
