...
@dataclass
class RandomNodeWithSwapCooling(SimulatedAnnealingSpaceSearchCooling):
    STRATEGY_ID: str = field(default=SimulatedAnnealingSpaceSearchCooling.TEMPERATURE_STRATEGY_ID + "RANDOM-NODE-WARMUP-SMA", init=False)
