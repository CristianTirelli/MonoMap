...
def backtracking(dfg_undir, arch, size_x, size_y):
    ...
    #
    # Algo:
    # - choose the unassigned node with the highest degree (max no. of edges)
    #
    # Idea:
    # - nodes with more connections are more constrained structurally,
    #   so assigning them earlier may reduce branching
    # -------------------------------------------------------------------------
    def pick_next():
        best_v = None
        best_dom = None
